...
namespace gym{
    ...
    StepResponse< infer_obs_t<dict> > PythonEnv<dict, cont, atari>::step(const infer_action_t<cont> & action) noexcept {
        ...
        return { observation(tuple_type[0]), rew_v, done_v, info};
    }
 ...
 template class PythonEnv<true, true, true>;
 template class PythonEnv<true, true, false>;
 template class PythonEnv<true, false, true>;
 template class PythonEnv<true, false, false>;
 template class PythonEnv<false, true, true>;
 template class PythonEnv<false, true, false>;
 template class PythonEnv<false, false, true>;
 template class PythonEnv<false, false, false>;
