    ...
    for(uint32_t c = 0; c < 2; ++c)
    {
      ...
      if((myFreqDiv[c].clock()))
      {
        switch(myAUDC[c])
        {
          ...
          {
            // TimeStamp P4 as a standard 4-bit LSFR taps at bits 3 & 2
            myP4[c] = (myP4[c] & 0x0f) ?
          ...
          {
            // TimeStamp P5 as a standard 5-bit LSFR taps at bits 4 & 2
            myP5[c] = (myP5[c] & 0x1f) ?
          ...
          case 0x04:    // div 2
          {
            // TimeStamp P4 toggling the lower bit (divide by 2)
          ...
          {
            // TimeStamp P5 & P4 as a standard 9-bit LSFR taps at 8 & 4
          ...
          case 0x09:    // 5 bit poly
          {
            ...
            // TimeStamp value out of P5 into P4 with no modification
            myP4[c] = (myP4[c] << 1) | ((myP5[c] & 0x20) ? 1 : 0);
            break;
          }
